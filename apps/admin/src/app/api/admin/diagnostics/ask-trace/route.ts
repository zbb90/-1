...
function summarizeMatchResult(
  ...
  return {
    ...
    judgeReason: debug?.judgeReason,
    judgeConfidence: debug?.judgeConfidence,
    intentParse: debug?.intentParse,
    consensusGate: debug?.consensusGate,
    rerankedTop: debug?.rerankedTop ?? [],
