...
async function requestIntentFromLlm(
  ...
  const raw = await requestDashScopeChat(
    "你是茶饮稽核问题理解器。只负责把用户问题抽取成结构化标签，不输出最终扣分结论。严格输出 JSON。sceneTags 仅可从：仓储区、私人物品区、冰箱、垃圾桶、吧台、阁楼 中选择；objectTags 仅可从：原物料、干橙片、奶油、麻薯、生椰乳、奇亚籽 中选择；issueTags 仅可从：无效期、过期、赏味期、废弃时间、破损、离地 中选择；claimTags 仅可从：个人食用主张、私人物品主张、门店反馈 中选择；exclusionTags 仅可从：非私人物品、非个人食用、无私人物品标识、非人为、已核实、可提醒 中选择；negationTags 仅可从：私人标识缺失、否定私人物品、否定个人食用、否定场景 中选择。",
    content,
    {
      maxTokens: 260,
